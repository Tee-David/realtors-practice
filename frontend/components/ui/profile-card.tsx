      ...
      <div ref={shellRef} className="relative z-[1] group">
        ...
        >
          ...
          >
                  ...
                  style={
                    {
                      ...
                      padding: 'clamp(8px, 2.5%, 12px) clamp(8px, 3%, 14px)'
                ...
                >
                  <div className="flex items-center gap-3">
                    <div
                      ...
                      style={{ width: 'clamp(32px, 10%, 48px)', height: 'clamp(32px, 10%, 48px)' }}
                    >
                      <img
                    ...
                    <div className="flex flex-col items-start gap-1.5" style={{ fontSize: 'clamp(0.65em, 0.8em, 0.875em)' }}>
                      <div className="font-medium text-white/90 leading-none">@{handle}</div>
                      <div className="text-white/70 leading-none">{status}</div>
                    </div>
                  </div>
                  <button
                    ...
                    style={{ pointerEvents: 'auto', display: 'block', gridArea: 'auto', borderRadius: '8px', padding: 'clamp(6px, 2%, 12px) clamp(10px, 3%, 16px)', fontSize: 'clamp(0.6em, 0.7em, 0.75em)' }}
                    type="button"
            ...
            >
              <div className="w-full absolute flex flex-col" style={{ top: 'clamp(1.5em, 8%, 3em)', display: 'flex', gridArea: 'auto' }}>
                <h3
                  className="font-semibold m-0"
                  style={{
                    fontSize: 'clamp(1.2em, 1.8em, 2.8em)',
                ...
                <p
                  ...
                  style={{
                    position: 'relative',
                    top: '-12px',
                    fontSize: 'clamp(0.75em, 0.9em, 1em)',
                    margin: '0 auto',
