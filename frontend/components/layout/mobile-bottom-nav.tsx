...
export function MobileBottomNav({ onOpenSidebar, extraButton }: BottomNavProps) {
  ...
  return (
    <nav
      className="md:hidden fixed bottom-4 left-1/2 -translate-x-1/2 z-[900] flex items-center justify-between w-[90%] px-2 py-2 rounded-full shadow-lg backdrop-blur-md print:hidden"
      style={{
